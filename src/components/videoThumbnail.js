...
import { transition } from './transitionAnimation.js';
...
export class VideoThumbnail {
    ...
    draw(id) {
        ...
        this.element.on(RODIN.CONST.GAMEPAD_BUTTON_UP, this.onClick.bind(this));
    ...
    addDescription(id) {
        ...
        description._threeObject.renderOrder = 5000;
